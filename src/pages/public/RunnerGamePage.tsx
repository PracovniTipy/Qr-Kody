...
const GAME_LABEL = 'Hospodský běh'
 ...
 * stejná kostra jako GamePage a FlappyGamePage, jen napojená na RunnerGame
 * a herní ID 'runner'. Server (start_game_session / submit_game_score,
 * migrace 0008–0011) hlídá realistickou délku hraní a maximální možné
 * skóre pro danou hru. Žebříček (get_game_leaderboard) je veřejný a
 * anonymní – hráčské účty (kapitola 9, Etapa 9) zatím nejsou, jen
 * dobrovolná přezdívka u skóre.
 */
export function RunnerGamePage() {
  ...
  return (
    <div className="game-page">
      ...
      {phase === 'playing' && <RunnerGame onGameOver={handleGameOver} />}
