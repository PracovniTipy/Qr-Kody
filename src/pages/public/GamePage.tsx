...
import { KosikGame } from '../../games/KosikGame'

const GAME_ID = 'kosik'
const GAME_LABEL = 'Chytání padajících surovin'
...
/**
 * Etapa 4 (masterplán, kapitola 11): první arkádová hra pro hosty u stolu.
 * Server (start_game_session / submit_game_score, migrace 0008) hlídá
 * realistickou délku hraní a maximální možné skóre pro danou hru – klient
 * si skóre nemůže jen tak vymyslet, stejně jako u objednávek (submit_order).
 * Žebříček (get_game_leaderboard) je veřejný a anonymní – hráčské účty
 * (kapitola 9, Etapa 9) zatím nejsou, jen dobrovolná přezdívka u skóre.
 */
export function GamePage() {
  ...
  return (
    <div className="game-page">
      ...
      {phase === 'playing' && <KosikGame onGameOver={handleGameOver} />}
