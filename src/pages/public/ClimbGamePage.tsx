...
import { ClimbGame } from '../../games/ClimbGame'

const GAME_ID = 'climb'
const GAME_LABEL = 'Skákání nahoru'
 ...
 * stejná kostra jako GamePage, FlappyGamePage a RunnerGamePage, jen napojená
 * na ClimbGame a herní ID 'climb'. Server (start_game_session /
 * submit_game_score, migrace 0008–0012) hlídá realistickou délku hraní a
 * maximální možné skóre pro danou hru. Žebříček (get_game_leaderboard) je
 * veřejný a anonymní – hráčské účty (kapitola 9, Etapa 9) zatím nejsou, jen
 * volná přezdívka u skóre.
 */
export function ClimbGamePage() {
  ...
  return (
    <div className="game-page">
      ...
      {phase === 'playing' && <ClimbGame onGameOver={handleGameOver} />}
