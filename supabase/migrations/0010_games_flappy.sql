-- StůlHraje – Etapa 4 (hra 2): "Let mezi sudy" (flappy-bird styl). Stejně
-- jako u hry "kosik" (migrace 0009) je hra nekonečná a anti-cheat (kapitola
-- 9.1) proto odvozuje maximální možné skóre od uplynulého času místo pevné
-- konstanty. Skóre roste nejvýš zhruba jednou za sud (frekvence sudů se sice
-- zvyšuje, ale realisticky nikdy nepřekročí cca 1 sud/s), takže
