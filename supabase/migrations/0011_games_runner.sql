-- StůlHraje – Etapa 4 (hra 3): "Hospodský běh" (endless runner, hospodský
-- vizuál). Stejně jako u předchozích dvou her (migrace 0009–0010) je hra
-- nekonečná a anti-cheat (kapitola 9.1) proto odvozuje maximální možné
-- skóre od uplynulého času místo pevné konstanty. Skóre roste nejvýš
-- zhruba jednou za překážku (frekvence překážek se sice zvyšuje, ale
-- realisticky nikdy nepřekročí cca 1 překážka/s), takže
-- max_score = elapsed_seconds * 1 + rezerva.
